  ...
  useEffect(()=>{
    const fetchData = async () => {
      if (window.ethereum) {
        ...
        const wa = adrs[0]
        const resp = await axios.post(url + "/user/getincome",{wa}, {
          headers: {
            "x-api-key": apikey,
          },
        });
  ...
  return (
    ...
    <div className="hero">
      <div className="content">
        <div className='text-2xl font-bold bg-primary p-2 border-round'>INCOME DETAILS</div>
        ...
        <div className="grid text-center">
          <div className="col-12">
            <div className="data1">
              ...
              <Button label='Details' size='small' onClick={()=>Navigate('/user/incomes/monthly')} />
            </div>
          </div>
        </div>
        <div className="grid text-center">
        ...
        <div className="grid text-center">
          ...
          <div className="data">
              ...
              <Button label='Details' size='small' onClick={()=>globalMessage()} />
            </div>
          </div>
          <div className="col-6">
          <div className="data">
        ...
        <div className="grid text-center">
          ...
          <div className="data1">
              ...
              <Button severity='warning' label='Details' size='small' onClick={()=>Navigate('/user/incomes/crown')} />
            </div>
          </div>
        ...
        <div className="grid text-center">
          ...
          <div className="data1">
              ...
              <Button severity='warning' label='Details' size='small' onClick={()=>Navigate('/user/incomes/reward')} />
            </div>
          </div>
        </div>
